...
const DEFAULT_EQUIPE = [
  {
    ...
    specialites: "Import & Logistique,Partenariats Chine,Négociations B2B,Coordination Afrique-Chine",
  ...
  },
  {
    ...
    email: "services@easychina.online",
    specialites: "Fret Maritime,Dédouanement,Inspection Qualité,Sourcing Usines",
...
function PageAccueil({ goTo }) {
  ...
  const officesList = [
    { flag: "🇹🇬", title: "Easy China Lomé", query: "https://images.unsplash.com/photo-1590846406792-0adc7f938f1d?auto=format&fit=crop&w=800&h=400&q=80", lines: ["Lomé, Togo", "WhatsApp: +228 90 61 92 88 / +228 99 51 37 18", "services@easychina.online"] },
