    ...
    return (
        <>
            <motion.div initial={{ scale: 0.98 }} animate={{ scale: 1 }} exit={{ scale: 0.98 }}
                ...
                className="fixed inset-0 w-full min-h-screen backdrop-blur-lg rounded-none sm:rounded-lg md:rounded-xl overflow-hidden z-10">
            ...
            <motion.div drag dragMomentum={false} dragElastic={0.1} initial={false}
                ...
                <motion.div className="relative rounded-xl bg-accent/20 backdrop-blur-xl border border-accent/30 shadow-lg cursor-grab active:cursor-grabbing">
    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            <div className="mb-8 text-center">
                <motion.h1 className="text-2xl sm:text-3xl md:text-4xl font-bold font-display bg-clip-text text-transparent bg-gradient-to-r from-text via-text/80 to-text"
                    initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
                    {title}
                </motion.h1>
                <motion.p className="mt-2 text-sm sm:text-base text-muted"
