...
export function CtaSection({ t }: Props) {
  return (
    <section
      className="section-py border-t border-[var(--color-border)] text-center"
    ...
    >
      <div className="container-base max-w-2xl">
        ...
        <p
          className="text-[var(--color-muted)] mb-10 mx-auto"
        ...
        <a
          ...
          className="inline-flex items-center gap-3 px-10 py-4 rounded-[var(--radius-md)] bg-[var(--color-accent)] text-white font-bold shadow-[var(--shadow-accent)] hover:bg-[var(--color-accent-strong)] transition-colors"
